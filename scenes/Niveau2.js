export default class niveau2 extends Phaser.Scene {
	...
	preload() {
		...
		this.load.audio("son_porte_niveau2", "assets/audio/porte_niveau6.mp3");
	...
	create() {
		...
		this.potion = this.physics.add.staticSprite(1000, map.heightInPixels-120, "img_items_sheet", 72);
	...
	goToAccueil() {
		if (this.cache.audio.exists("son_porte_niveau2")) {
			try {
				...
				console.warn("Niveau2: lecture du son de porte impossible", error);
			}
		}
